cd ..
wzzip -P -jhrs pwlib_min.zip pwlib/Readme.txt pwlib/History.txt pwlib/mpl-1.0.htm pwlib/*.dsw pwlib/include/ptlib.h
...
wzzip -P -jhrs pwlib_full.zip pwlib/Readme.txt pwlib/History.txt pwlib/mpl-1.0.htm pwlib/*.dsw
