...
PCREATE_DEVICE_PLUGIN(PSoundChannelOSS, PSoundChannel, "OSS");
...
BOOL PSound::Play()
{
  PSoundChannel channel(PSoundChannelOSS::GetDefaultDevice(PSoundChannelOSS::Player),
                        PSoundChannelOSS::Player);
  if (!channel.IsOpen())
    return FALSE;
