...
"$(INTDIR)\safecoll.obj" : $(SOURCE) "$(INTDIR)" "$(INTDIR)\Console.pch"
	$(CPP) $(CPP_PROJ) $(SOURCE)
...
"$(INTDIR)\safecoll.obj"	"$(INTDIR)\safecoll.sbr" : $(SOURCE) "$(INTDIR)" "$(INTDIR)\Console.pch"
	$(CPP) $(CPP_PROJ) $(SOURCE)
