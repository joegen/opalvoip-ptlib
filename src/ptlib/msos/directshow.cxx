...
static PString ParseName(const PString & name, PINDEX & devNo)
{

}


static bool BindFilter(const PString & DeviceName, IBaseFilter **pFilter)
{
  PINDEX devNo = 0;
  PString name = ParseName(DeviceName,devNo);

  // enumerate all video capture devices
  PComPtr<ICreateDevEnum> pCreateDevEnum;
